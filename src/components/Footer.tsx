      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md mb-6">
              MedDrapes is a leading manufacturer of high-quality surgical drapes, 
              committed to enhancing safety and efficiency in healthcare environments 
              around the world.
            </p>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            © {new Date().getFullYear()} MedDrapes. All rights reserved.
          </p>
          
          <button 
            onClick={scrollToTop}
            className="flex items-center justify-center p-2 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors duration-300"
